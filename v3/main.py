...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    texto = FONTE_PONTOS.render(f'Pontuação {pontos}', 0, (255, 255, 255))
    tela.blit(texto, (TELA_LARGURA - 10 - texto.get_width(), 10))

    if ai_jogando:
        texto = FONTE_PONTOS.render(f'Geração {geracao}', 0, (255, 255, 255))
        tela.blit(texto, (10, 10))
    else:
        texto = FONTE_PONTOS.render(f'Record {record}', 0, (255, 255, 255))
        tela.blit(texto, (10, 10))
...
def menu():
    ...
    while True:
        ...
        texto1 = fonte.render('Pressione "H" para Jogador', True, (255, 255, 255))
        texto2 = fonte.render('Pressione "A" para IA', True, (255, 255, 255))
        tela.blit(texto1, (TELA_LARGURA/2 - texto1.get_width()/2, TELA_ALTURA/2 - 50))
        tela.blit(texto2, (TELA_LARGURA/2 - texto2.get_width()/2, TELA_ALTURA/2))
